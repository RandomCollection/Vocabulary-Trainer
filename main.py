        ...
        ScreenManager:
            ...
            Screen:
                ...
                MDLabel:
                    text:
                        ...
                        it is solved incorrectly and increases by one if it is solved correctly. The probability of \
                        the words to show up are based on their weights, which are calculated as 'sensitivity ** \
                        ((-1) * level of word)'. Hence, the probability of seeing the corresponding word again \
                        decreases or increases exponentially with the number of correct or incorrect translations, \
                        respectively. The sensitivity has a default value of two, but it can be adjusted using the \
                        below [b]SENSITIVITY[/b] button. The levels can be reset by pressing the [b]RESET[/b] button \
                        in the [b]Statistics[/b] section. Depending on the category and level selection of the \
                        [b]Start[/b] screen, it is possible to only reset the levels of a subsection.\n\n\
                        ...
                        default setting is from Spanish to German. Choose whether you want to practise a specific \
                        category of words via the [b]CATEGORY[/b] button. The default setting is [b]All[/b]. Choose \
                        whether you want to practise a specific level of words via the [b]LEVEL[/b] button. The \
                        default setting is [b]All[/b].\
                        "
                    markup: True
                    font_style: "Body2"
                    halign: "left"
            ...
            Screen:
                ...
                MDLabel:
                    ...
                    on_ref_press: app.open_link(link="https://github.com/RandomCollection/Vocabulary-Trainer")
