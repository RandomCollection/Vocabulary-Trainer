...
URL_DATABASE = r"https://github.com/RandomCollection/Vocabulary-Trainer/blob/main/vocabulary.xls?raw=true"
...
LABEL_COUNTER_STREAK_NUMBER = "{current} / {best}"
LABEL_COUNTER_STREAK_TEXT = "Streak"
LABEL_COUNTER_WORDS_NUMBER = "{current} / {total}"
LABEL_COUNTER_WORDS_TEXT = "Words"
...
[b]COUNTERS[/b] - Counters can be set [b]On[/b] or [b]Off[/b] to be displayed on the [b]Start[/b] screen. The streak \
counter shows the current and best streak and the words counter shows the number of words of the current session and \
the overall word count. They can be reset by pressing the [b]RESET[/b] button in the right bottom corner.\
"""
LABEL_SOLUTION_CORRECT = "[color=238823]Correct =)[/color]"
LABEL_SOLUTION_INCORRECT = "[color=D2222D]Incorrect =([/color]"
LABEL_START = "Please press the [i]START[/i] button to start"
LABEL_STATISTICS = """\
...
LABEL_UPDATE = """\
[b]IMPORT[/b] - In order to update the underlying vocabulary list, the [b]IMPORT[/b] button can be pressed, which \
downloads an updated vocabulary list from the corresponding [b]RandomCollection[/b] GitHub repository.\n
[b]EXPORT[/b] - The underlying database [b]data.db[/b] of the [b]Vocabulary Trainer[/b] can be exported by pressing \
the [b]EXPORT[/b] button. The database will be stored in the Android [b]Download[/b] folder from which it can be \
further processed.\n
Please wait a moment for the process to complete after pressing any of the below buttons.\
"""
